      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 md:py-12 flex gap-8">
        ...
        <aside className="hidden lg:block w-60 shrink-0">
          ...
          <div className="mt-6 glass rounded-2xl p-4">
            <div className="text-sm font-semibold text-white mb-1">Upgrade Your Workflow</div>
            <p className="text-xs text-[var(--text-muted)] mb-3">
              Premium bots. Verified creators. Real results.
            </p>
            <Link
              href="/join"
              className="btn-neon inline-block w-full text-center px-3 py-2 text-xs font-semibold"
            >
              Explore Premium
            </Link>
          </div>
        ...
        <main className="flex-1 min-w-0">
          ...
          >
            <div className="flex items-center justify-between gap-4 flex-wrap mb-2">
              <h1 className="text-3xl md:text-4xl font-bold text-white title-3d">
